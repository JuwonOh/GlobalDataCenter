...
## NA -> ""
thinktank_data$content[is.na(thinktank_data$content)] <- ""
...
## "" -> NA
thinktank_data$content[thinktank_data$content==""] <- NA
thinktank_data$title[thinktank_data$title==""] <- NA
thinktank_data$summary[thinktank_data$summary==""] <- NA
